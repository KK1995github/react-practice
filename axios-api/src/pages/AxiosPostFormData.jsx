  ...
  return (
    <div>
        <div className="main">
            <form>
                <label>ID</label>
                <input type="text" name="id" value={data.id} placeholder='Enter Id' onChange={handleInput}    />

                <label>Type</label>
                <input type="text" name="type" value={data.type} placeholder='Enter type' onChange={handleInput} />

                <label>Name</label>
                <input type="text" name="name" value={data.name} placeholder='Enter name' onChange={handleInput} />

                <label>Ppu</label>
                <input type="text" name="ppu" value={data.ppu} placeholder='Enter ppu' onChange={handleInput} />
                <br />
...
{data.batters.batter.map((batter, index)=>(
    ...
    <label>ID:</label>
    <input type='text' name={`batters.batter[${index}].id`} value={batter.id} onChange={(e)=> handleInputB(e,index) } />
    <label>Type:</label>
    <input type='text' name={`batters.batter[${index}].type`} value={batter.type} onChange={(e)=> handleInputB(e,index) } />
    </div>
...
{data.topping.map((topp, index) => {
    return(
        <div key={index}>
            <label>id</label>
            <input type='text' name={topp.id} value={topp.id}  onChange={(e)=> handleInputT(e,index) }  />

            <label>Type</label>
            <input type='text' name={topp.type}value={topp.type} onChange={(e)=> handleInputT(e,index) } />
        </div>
    )
})}
